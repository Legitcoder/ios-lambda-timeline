...
class PostController {
    ...
    func createPost(with title: String, geotag: CLLocationCoordinate2D? = nil, ofType mediaType: MediaType, mediaData: Data, ratio: CGFloat? = nil, completion: @escaping (Bool) -> Void = { _ in }) {
        ...
        store(mediaData: mediaData, mediaType: mediaType) { (mediaURL) in
            ...
            let imagePost = Post(title: title, mediaURL: mediaURL, geotag: geotag, ratio: ratio, author: author)
